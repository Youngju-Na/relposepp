...
def rays_to_cameras(
    ...
    if cameras is None:
        I_camera = PerspectiveCameras(focal_length=focal_lengths.expand(rays.shape[0], -1), principal_point=principal_points.expand(rays.shape[0], -1), device=device).clone()
